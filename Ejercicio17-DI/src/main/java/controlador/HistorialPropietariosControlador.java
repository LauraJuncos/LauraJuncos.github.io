...
public class HistorialPropietariosControlador {
    ...
    public List<HistorialPropietariosDTO> aplicarFiltros(String nombre, String marca, String sexo, 
        ...
        validarFiltros(nombre, marca, sexo, modelo, anio, numVehiculos);
    ...
    // Método privado para validar los filtros y evitar SQL injection
    private void validarFiltros(String nombre, String marca, String sexo, String modelo, String anio, String numVehiculos) throws SQLException {
        if (contieneCaracteresEspeciales(nombre) || contieneCaracteresEspeciales(marca) || contieneCaracteresEspeciales(sexo)
                || contieneCaracteresEspeciales(modelo) || contieneCaracteresEspeciales(anio) || contieneCaracteresEspeciales(numVehiculos)) {
            throw new SQLException("Los filtros contienen caracteres especiales no permitidos.");
        }
    }

    // Método privado para verificar si un filtro contiene caracteres especiales
